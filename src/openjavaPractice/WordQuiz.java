...
public class WordQuiz {
   public static void main(String[] args) {
      var v = new Vector<Word8>();
      v.add(new Word8("love", "사랑"));
      v.add(new Word8("animal", "동물"));
      v.add(new Word8("dog", "강아지"));
      v.add(new Word8("cat", "고양이"));
      v.add(new Word8("computer", "컴퓨터"));
      v.add(new Word8("bag", "가방"));
      v.add(new Word8("book", "책"));
      v.add(new Word8("pencil", "연필"));
      v.add(new Word8("cloth", "옷"));
      v.add(new Word8("pants", "바지"));
      v.add(new Word8("head", "머리"));
      v.add(new Word8("hand", "손"));
      v.add(new Word8("foot", "발"));
      v.add(new Word8("arm", "팔"));
      v.add(new Word8("cigarettes", "담배"));
      v.add(new Word8("fire", "불"));
      v.add(new Word8("water", "물"));
